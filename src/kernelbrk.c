...
extern int find_frame(unsigned char *track, unsigned long frames);
extern void frame_alloc(unsigned char *track, int pfn);
extern void frame_free(unsigned char *track, int pfn);
